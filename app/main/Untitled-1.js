...
//             <li className="fact">
//               <p>
//                 Millennial dads spend 3 times as much time with their kids than their fathers spent
//                 with them. In 1982, 43% of fathers had never changed a diaper. Today, that number is
//                 down to 3%
//                 <a
//                   className="source"
...
//               {storedText.length > 0?(
//           <p>
//             {storedText.map((storedText,index)=>(
//               <li key={index}>{storedText}</li>))}</p>)
//               :(<p>No Stored Text</p>)
//               }
//               </p>
//                 {/* <a className="source" href="https://opensource.fb.com/" target="_blank">
